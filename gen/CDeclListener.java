...
public interface CDeclListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterVoid(CDeclParser.VoidContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Void}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void exitVoid(CDeclParser.VoidContext ctx);
	/**
	 * Enter a parse tree produced by the {@code Float}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void enterFloat(CDeclParser.FloatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Float}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void exitFloat(CDeclParser.FloatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code Int}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void enterInt(CDeclParser.IntContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Int}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void exitInt(CDeclParser.IntContext ctx);
	/**
	 * Enter a parse tree produced by the {@code Key}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void enterKey(CDeclParser.KeyContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Key}
	 * labeled alternative in {@link CDeclParser#typename}.
	 * @param ctx the parse tree
	 */
	void exitKey(CDeclParser.KeyContext ctx);
	/**
